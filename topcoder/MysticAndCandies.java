...
// BEGIN CUT HERE
    public static void main(String[] args) {
        RETester.test(MysticAndCandies.class, "test.*");
    }

	public void test0() {
		RETester.eq(minBoxes(15, 12, new int[] {1, 2, 3, 4, 5}, new int[] {1, 2, 3, 4, 5}), 3);
	}

	public void test1() {
		RETester.eq(minBoxes(60, 8, new int[] {5, 2, 3}, new int[] {49, 48, 47}), 2);
	}

	public void test2() {
		RETester.eq(minBoxes(58, 30, new int[] {3, 9, 12, 6, 15}, new int[] {8, 12, 20, 8, 15}), 2);
	}

	public void test3() {
		RETester.eq(minBoxes(207581165, 172146543, new int[] {
	...
	public void test4() {
		RETester.eq(minBoxes(43873566, 32789748, new int[] {2053198, 2175819, 4260803, 1542497, 1418952, 5000015, 1381849, 2462882, 6466891, 1827580, 6943641, 5775477}, new int[] {2827461, 3726335, 5410505, 4781355, 4925909, 5621160, 7325774, 5025476, 7876037, 8072075, 6979462, 6647628}), 7);
	}
